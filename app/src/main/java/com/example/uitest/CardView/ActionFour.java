...
public class ActionFour extends AppCompatActivity implements View.OnClickListener{
    ...
    Thread getData = new Thread(new Runnable() {
        ...
        public void run() {
            ...
            if(Me.user.getActionTimeThisWeek(Me.user.getAccount(),"callUp")!=null){
                System.out.println("1516111111111111111111111111111111");
                try {
                    dayData[0] =Me.user.getActionTimeThisWeek(Me.user.getAccount(),"callUp");
            ...
            if(Me.user.getActionTimeWeekly(Me.user.getAccount(),"callUp")!=null){
                try {
                    xValues=new ArrayList<>();
                    weekData=Me.user.getActionTimeWeekly(Me.user.getAccount(),"callUp");
