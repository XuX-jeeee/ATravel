...
public class ActionOne extends AppCompatActivity implements View.OnClickListener{
    ...
    Thread getData = new Thread(new Runnable() {
        ...
        public void run() {
            ...
            if(Me.user.getActionTimeThisWeek(Me.user.getAccount(),"closeEyes")!=null){
                System.out.println("1516111111111111111111111111111111");
                try {
                    dayData[0] =Me.user.getActionTimeThisWeek(Me.user.getAccount(),"closeEyes");
                ...
                if(Me.user.getActionTimeWeekly(Me.user.getAccount(),"closeEyes")!=null){
                    try {
                        xValues=new ArrayList<>();
                        weekData=Me.user.getActionTimeWeekly(Me.user.getAccount(),"closeEyes");
