...
public class ActionTwo extends AppCompatActivity implements View.OnClickListener{
    ...
    Thread getData = new Thread(new Runnable() {
        ...
        public void run() {
            ...
            if(Me.user.getActionTimeThisWeek(Me.user.getAccount(),"yawn")!=null){
                System.out.println("1516111111111111111111111111111111");
                try {
                    dayData[0] =Me.user.getActionTimeThisWeek(Me.user.getAccount(),"yawn");
            ...
            if(Me.user.getActionTimeWeekly(Me.user.getAccount(),"yawn")!=null){
                try {
                    xValues=new ArrayList<>();
                    weekData=Me.user.getActionTimeWeekly(Me.user.getAccount(),"yawn");
