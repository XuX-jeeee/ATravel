...
public class ActionFive extends AppCompatActivity implements View.OnClickListener{
    ...
    Thread getData = new Thread(new Runnable() {
        ...
        public void run() {
            ...
            if(Me.user.getActionTimeThisWeek(Me.user.getAccount(),"noSafetyBelts")!=null){
                System.out.println("1516111111111111111111111111111111");
                try {
                    dayData[0] =Me.user.getActionTimeThisWeek(Me.user.getAccount(),"noSafetyBelts");
            ...
            if(Me.user.getActionTimeWeekly(Me.user.getAccount(),"noSafetyBelts")!=null){
                try {
                    xValues=new ArrayList<>();
                    weekData=Me.user.getActionTimeWeekly(Me.user.getAccount(),"noSafetyBelts");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_action_five);
        for(int i=0;i<7;i++)
        {
            dayDataList.add(i,0);
        }
